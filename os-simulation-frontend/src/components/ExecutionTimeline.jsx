// // components/ExecutionTimeline.jsx
...
//   // Don't render if there's no result or timeline
//   if (!result || !result.timeline) return null;

//   const timeline = createExecutionTimeline(result, algorithmType);
