...
//       const response = await axios.post("/api/sjf", processes);
...
//                 Process {item.processId}: Start Time = {item.startTime},
//                 Completion Time = {item.completionTime}
//                 {item.turnaroundTime !== undefined && (
//                   <span>
//                     , Turnaround Time = {item.turnaroundTime}, Waiting Time ={" "}
//                     {item.waitingTime}
//                   </span>
//                 )}
//               </li>
...
//         processes={processes}
//         result={result}
//         algorithmType="SJF" // Change based on component
//       />
//     </div>
//   );
// };
        ...
        <>
          {result.timeline &&
            ...
            result.timeline.length > 0 && (
              <ExecutionTimeline result={result} algorithmType="SJF" />
            )}
