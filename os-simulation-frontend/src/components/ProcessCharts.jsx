...
//     burstTime:
//       processes.find((p) => p.processId === process.processId)?.burstTime || 0,
//   }));

//   // Calculate chart dimensions
//   const maxCompletionTime = Math.max(...result.map((p) => p.completionTime));

//   // Custom colors for processes
//   const colors = [
//     "#2563eb",
//     "#16a34a",
//     "#dc2626",
...
//         </h3>
//         <ResponsiveContainer width="100%" height={result.length * 60 + 50}>
//           <BarChart
//             layout="vertical"
//             data={ganttData}
//             barSize={30}
...
//             <XAxis type="number" domain={[0, maxCompletionTime]} />
//             <YAxis dataKey="processId" type="category" />
//             <Tooltip
...
//               }}
//             />
//             <Bar dataKey="duration" fill="#2563eb" shape={<CustomGanttBar />} />
//           </BarChart>
//         </ResponsiveContainer>
//       </div>
...
//           >
//             <CartesianGrid strokeDasharray="3 3" />
//             <XAxis dataKey="processId" />
//             <YAxis />
//             <Tooltip />
//             <Legend />
//             <Bar dataKey="waitingTime" name="Waiting Time" fill="#2563eb" />
//             <Bar
//               dataKey="turnaroundTime"
//               name="Turnaround Time"
//               fill="#16a34a"
//             />
//             <Bar dataKey="burstTime" name="Burst Time" fill="#dc2626" />
//           </BarChart>
//         </ResponsiveContainer>
//       </div>
...
//         <p className="font-medium text-slate-800">{`Process ${data.processId}`}</p>
//         <p className="text-sm text-slate-600">{`Start Time: ${data.start}`}</p>
//         <p className="text-sm text-slate-600">{`End Time: ${data.end}`}</p>
//       </div>
//     );
//   }
//   return null;
...
//     return (
//       <div className="bg-white p-3 border border-slate-200 shadow-lg rounded-lg">
//         <p className="font-medium text-slate-800">{`Process ${label}`}</p>
...
// // Modern tooltip for Gantt chart
// const CustomTooltip = ({ active, payload, label }) => {
//   if (active && payload && payload.length) {
//     const data = payload[0].payload;
//     return (
//       <div
//         className="bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-lg border border-slate-200"
//         style={{
...
//           Process Timeline
//         </h3>
//         <ResponsiveContainer width="100%" height={result.length * 70 + 50}>
//           <BarChart
//             layout="vertical"
//             data={ganttData}
//             barSize={40}
...
//               position={{ y: 0 }}
//             />
//             <Bar dataKey="duration" fill="#3b82f6" shape={<CustomGanttBar />} />
//           </BarChart>
//         </ResponsiveContainer>
//       </div>
...
//             <Tooltip content={<MetricsTooltip />} cursor={false} />
//             <Legend />
//             <Bar
//               dataKey="waitingTime"
//               name="Waiting Time"
