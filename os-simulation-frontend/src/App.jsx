...
//       <div className="hidden lg:block px-6 py-6 border-b border-slate-200">
//         <h1 className="text-xl font-semibold text-slate-800">OS Visualizer</h1>
//         <p className="text-sm text-slate-500 mt-1">Operating System Concepts</p>
//       </div>
...
//               className="flex items-center w-full p-3 text-left rounded-lg transition-all hover:bg-slate-50 group"
//             >
